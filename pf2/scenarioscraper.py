...
for link in links:
	...
	#print "levels: " +levels
	#print output
	lineout="INSERT INTO scenarios (gametype,gameseason,scenarionum,scenarioname,scenariodesc,levellow,levelhigh) VALUES ('"+gametype+"','"+gameseason+"','"+scenarionum+"','"+gamename+"','"+output.replace('"','\\"').replace("'","\\'").rstrip("\n\r").rstrip("\n")+"','"+levellow+"','"+levelhigh+"');"
